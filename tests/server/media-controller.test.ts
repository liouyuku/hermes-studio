...
describe('media controller', () => {
      ...
      const ctx: any = {
        ...
        request: {
          body: {
            ...
            mode: 'text',
            prompt: 'make an icon',
            output_path: '/tmp/hermes-web-ui-test-home/media/agnes-image.png',
          },
        },
        get: vi.fn(() => ''),
        status: 200,
  ...
  it('rejects image_path reads and output_path writes outside the Web UI home', async () => {
    process.env.HERMES_WEB_UI_HOME = '/tmp/hermes-web-ui-test-home'
    vi.stubEnv('AGNES_API_KEY', 'agnes-secret')
    vi.doMock('../../packages/server/src/services/hermes/hermes-profile', () => ({
      getActiveProfileName: () => 'default',
      ...
      const ctx: any = {
        ...
        request: {
          body: {
            ...
            output_path: '/tmp/hermes-web-ui-test-home/media/out.png',
          },
        },
        get: vi.fn(() => ''),
        status: 200,
  ...
  it('rejects output_path writes with a disallowed extension outside the Web UI home', async () => {
    process.env.HERMES_WEB_UI_HOME = '/tmp/hermes-web-ui-test-home'
    vi.stubEnv('AGNES_API_KEY', 'agnes-secret')
    vi.doMock('../../packages/server/src/services/hermes/hermes-profile', () => ({
      getActiveProfileName: () => 'default',
    ...
    try {
      ...
      const ctx: any = {
        ...
        request: {
          body: {
            ...
            mode: 'text',
            prompt: 'make an icon',
            output_path: '/tmp/hermes-web-ui-test-home/media/evil.sh',
          },
        },
        get: vi.fn(() => ''),
        status: 200,
      ...
      expect(ctx.body).toEqual({ error: 'Unsupported output extension', code: 'invalid_path' })
    } finally {
      globalThis.fetch = originalFetch
    }
  })
